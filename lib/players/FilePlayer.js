    ...
    value: function load(url) {
      ...
      if (this.shouldUseDASH(url)) {
        (0, _utils.getSDK)(DASH_SDK_URL, DASH_GLOBAL).then(function (dashjs) {
          _this2.mediaPlayer = dashjs.MediaPlayer();
          _this2.dash = _this2.mediaPlayer.create();
          _this2.mediaPlayer.addEventListener(dashjs.MediaPlayer.events.STREAM_INITIALIZED, function () {
            _this2.props.onInitialised(_this2.mediaPlayer);
          });
