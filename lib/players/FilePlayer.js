...
var DASH_SDK_URL = 'https://cdnjs.cloudflare.com/ajax/libs/dashjs/2.8.0/dash.all.min.js';
    ...
    value: function load(url) {
      ...
      if (this.shouldUseDASH(url)) {
        (0, _utils.getSDK)(DASH_SDK_URL, DASH_GLOBAL).then(function (dashjs) {
          ...
          _this2.dash.on(dashjs.MediaPlayer.events['STREAM_INITIALIZED'], function (e) {
